...
export const EventScheduleConstants = [
  ...
  { id: 7, time: "11:45 AM", title: "Panel Discussion I", description: "Promoting Inclusive AI Development"},
  { id: 8, time: "12:30 PM", title: "Panel Discussion II", description: "Societal Adoption of AI: Opportunities & Challenges"},
  { id: 9, time: "1:00 PM", title: "Lunch"},
  { id: 10, time: "2:00 PM", title: "Startup Pitch Event", description: "Theme: AI for All"},
  { id: 11, time: "3:00 PM", title: "Coffee Break & Networking"},
  { id: 12, time: "3:30 PM", title: "AI and Me", description: "Student Perspectives on AI and its Future"},
  { id: 13, time: "4:30 PM", title: "Results & Closing Session"},
  { id: 14, time: "5:00 PM", title: "Working Group Hybrid Meeting / AI at IITH Poster Session"},
