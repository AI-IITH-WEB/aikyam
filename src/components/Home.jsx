      ...
      <div className="flex flex-col gap-16 w-full min-h-[100vh] justify-center items-center bg-gradient-to-r from-gray-700 via-teal-800 to-teal-700 p-10 md:p-20">
        <AnimatedSection>
          {/* <div className="flex gap-6 md:gap-12 2xl:gap-16 w-full justify-center items-center p-4">
            ...
            <img
              ...
              alt="AI dept logo"
              className="w-20 md:w-28 lg:w-[130px] 2xl:w-[170px] h-auto object-contain"
            />
            </a>
            ...
            <img
              ...
              alt="AI dept logo"
              className="w-64 md:w-96 lg:w-[400px] 2xl:w-[600px] h-auto object-contain"
            />
            </a>
          </div> */}
        </AnimatedSection>
        ...
        <AnimatedSection delay={400}>
          <div className="flex gap-4 flex-wrap items-center justify-center">
            ...
            <button className="text-white text-xl md:text-2x font-medium px-8 py-4 rounded-full border border-solid transition-colors">
              Register
            </button>
          </div>
        </AnimatedSection>
